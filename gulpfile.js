...
const isProd = $.util.env.p || $.util.env.production;

// Каталоги и файлы
const app = 'app'; // Исходники
const dist = `build/${isProd ? 'production' : 'dist'}`; // Собранный проект
const temp = 'build/temp'; // Служебные файлы
const more = 'more/'; // Дополнительные материалы для работы
const jsonName = 'data.json'; // Имя JSON файла
const tasks = './tasks'; // Задачи галпа
